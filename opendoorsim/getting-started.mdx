...
<Steps>
  ...
  <Step title="Build  OpenDoorSim" titleSize="h2">
    <CardGroup cols={2}>
      <Card title="Screen and Encoder" icon="rocket-launch" href="https://shortrange.tech/store/">
        Support the project directly! Comes with everything you need, including:
      ...
      <Card title="LAB Case" icon="industry-windows" href="/index">
        Good for experts and makers. You will need to do the following:
  ...
  <Step title="Connect Your Reader and Start Scanning!" titleSize="h2">
  </Step>
</Steps>
